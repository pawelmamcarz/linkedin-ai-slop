...
Bundle id aplikacji: `com.mamcarz.linkedinaislop`. Rozszerzenie: `com.mamcarz.linkedinaislop.extension`. Wersja: `0.2.2` (`extension/manifest.json` i `safari/Config/Shared.xcconfig`).
