...
`MARKETING_VERSION` jest w `safari/Config/Shared.xcconfig` i ma być równy `extension/manifest.json` (teraz 0.2.2). Skrypty build i archive i tak podają wersję z manifestu do `xcodebuild`.
